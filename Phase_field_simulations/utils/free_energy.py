...
Modules that are used to define the:
    ...
    2. RNA synthesis and degradation reactions
"""
...
class RNA_reactions():
    ...
    """
    def __init__(self,k_production,k_degradation,threshold=0.0,t_change=0.0,multiplier=1.0,m1=1.0,kp_noise=0.0):
    ...
    def production(self,phi_p,phi_r,t):
        ...
        """
        rate = max(0,self.k_production+np.random.normal(scale=self.kp_noise));
